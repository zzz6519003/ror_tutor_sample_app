...
describe User do
	...
	describe "when email format is invalid" do
		it "should be invalid" do
			# addresses = %w[user@foo,com user at foo.org example.user@foo.com foo@bar baz.com foo@bar+baz.com]
	...
	# describe "when email format is valid" do
		...
		# 	addresses = %w[user@foo.COM A US-ER@fb.org frst.lst@foo.jp a+b@baz.cn]
